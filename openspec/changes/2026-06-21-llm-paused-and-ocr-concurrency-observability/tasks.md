...
- [ ] 2.1 Add backend TDD coverage and implement thread-pool capacity metrics plus page-task worker runtime settings exposure.
- [ ] 2.2 Add page-task execution TDD coverage proving two queued pages can run concurrently on one OCR node with available slots.
- [ ] 2.3 Update dashboard metric types and resource cards with TDD coverage to display active OCR work against configured capacity.
