...
## Purpose
Define how DocLens-j identifies calling systems through request credentials and
exposes caller attribution across upload, callback, and Dashboard surfaces
without introducing personal login, user accounts, or RBAC.
