# caller-key-isolation Specification

## Purpose
Define how DocLens-j uses `X-Doclens-Key` as an opaque caller partition key for
data isolation, dashboard visibility, traffic limits, and global stop-loss
without treating the key as identity proof.
## Requirements
