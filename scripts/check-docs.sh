...
REQUIRED_FILES=(
  ...
  "docs/permission-configuration_zh.md"
  "docs/development.md"
...
REQUIRED_CONTENT=(
  ...
  "docs/configuration.md|permission-configuration.md"
  "docs/permission-configuration.md|Permission Configuration"
  "docs/permission-configuration.md|Production Configuration"
  "docs/permission-configuration.md|Development Configuration"
  "docs/permission-configuration.md|What principal roles and allowed partitions mean"
  "docs/permission-configuration.md|platform-admin"
  "docs/permission-configuration.md|X-Doclens-Key"
  "docs/permission-configuration_zh.md|权限配置"
  "docs/permission-configuration_zh.md|生产环境配置"
  "docs/permission-configuration_zh.md|开发环境配置"
  "docs/permission-configuration_zh.md|roles 和 allowed-partitions 到底是什么意思"
  "docs/permission-configuration_zh.md|platform-admin"
  "docs/permission-configuration_zh.md|X-Doclens-Key"
